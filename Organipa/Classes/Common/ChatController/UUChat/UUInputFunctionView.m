...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    CGRect frame = CGRectMake(0, WFSCREEN_H-40, WFSCREEN_W, 40);
    ...
    if (self) {
        ...
        self.btnSendMessage.frame = CGRectMake(WFSCREEN_H-40, 5, 30, 30);
        ...
        self.btnVoiceRecord.frame = CGRectMake(70, 5, WFSCREEN_W-70*2, 30);
        ...
        //输入框
        self.TextViewInput = [[UITextView alloc]initWithFrame:CGRectMake(45, 5, WFSCREEN_W-2*45, 30)];
